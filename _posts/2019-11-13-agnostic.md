...
어떻게 될까요?
    ...
    ## -1.2601  -0.5854  -0.5854   1.0969   1.9227  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)   0.1924     0.2352   0.818    0.413    
    ## x            -1.8695     0.3386  -5.521 3.37e-08 ***
    ## ---
    ...
    ## Residual deviance: 211.14  on 198  degrees of freedom
    ## AIC: 215.14
    ## 
...
그런데 이 분석을 한국인과 페루인에서 따로 진행하면 어떤 결과가 나올까요?
    ...
    ## Deviance Residuals: 
    ##    Min      1Q  Median      3Q     Max  
    ## -1.291  -1.291   1.068   1.068   1.261  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)
    ## (Intercept)   0.2624     0.2428   1.080    0.280
    ## x.kor        -0.4565     0.4350  -1.049    0.294
    ## 
    ## (Dispersion parameter for binomial family taken to be 1)
    ## 
    ##     Null deviance: 138.27  on 99  degrees of freedom
    ## Residual deviance: 137.16  on 98  degrees of freedom
    ## AIC: 141.16
    ## 
    ## Number of Fisher Scoring iterations: 3
    ...
    ## Deviance Residuals: 
    ##     Min       1Q   Median       3Q      Max  
    ## -0.7585  -0.3593  -0.3593  -0.3593   2.3548  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)
    ## (Intercept)   -1.099      1.155  -0.951    0.341
    ## x.per         -1.609      1.229  -1.309    0.190
    ## 
    ## (Dispersion parameter for binomial family taken to be 1)
    ## 
    ##     Null deviance: 50.728  on 99  degrees of freedom
    ## Residual deviance: 49.387  on 98  degrees of freedom
    ## AIC: 53.387
    ## 
