...
어떻게 될까요?
    ...
    ## -1.0349  -0.4631  -0.4631  -0.4631   2.1381  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)  -0.3448     0.2242  -1.538    0.124    
    ## x            -1.8337     0.3782  -4.849 1.24e-06 ***
    ## ---
    ...
    ## Residual deviance: 188.87  on 198  degrees of freedom
    ## AIC: 192.87
    ## 
...
그런데 이 분석을 한국인과 페루인에서 따로 진행하면 어떤 결과가 나올까요?
    ...
    ## Deviance Residuals: 
    ##    Min      1Q  Median      3Q     Max  
    ## -1.079  -1.079  -1.068   1.279   1.291  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)
    ## (Intercept) -0.23484    0.22949  -1.023    0.306
    ## x.kor       -0.02752    0.47915  -0.057    0.954
    ## 
    ## (Dispersion parameter for binomial family taken to be 1)
    ## 
    ##     Null deviance: 137.19  on 99  degrees of freedom
    ## Residual deviance: 137.18  on 98  degrees of freedom
    ## AIC: 141.18
    ## 
    ...
    ## Deviance Residuals: 
    ##     Min       1Q   Median       3Q      Max  
    ## -0.2063  -0.2063  -0.2063  -0.2063   2.7788  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)
    ## (Intercept)   -18.57    2917.01  -0.006    0.995
    ## x.per          14.73    2917.01   0.005    0.996
    ## 
    ## (Dispersion parameter for binomial family taken to be 1)
    ## 
    ##     Null deviance: 19.608  on 99  degrees of freedom
    ## Residual deviance: 19.401  on 98  degrees of freedom
    ## AIC: 23.401
    ## 
...
<center>
![LD와 물리적 거리 사이의 관계 (Sodeland et al. 2011)](img/ld.png)
