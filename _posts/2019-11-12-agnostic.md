...
어떻게 될까요?
    ...
    ## -1.0713  -0.5645  -0.5645  -0.1015   1.9572  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)    
    ## (Intercept)  -0.2549     0.2393  -1.065    0.287    
    ## x            -1.5011     0.3449  -4.352 1.35e-05 ***
    ## ---
    ...
    ## Residual deviance: 205.12  on 198  degrees of freedom
    ## AIC: 209.12
    ## 
...
그런데 이 분석을 한국인과 페루인에서 따로 진행하면 어떤 결과가 나올까요?
    ...
    ## Deviance Residuals: 
    ##    Min      1Q  Median      3Q     Max  
    ## -1.090  -1.090  -1.051   1.268   1.310  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)
    ## (Intercept) -0.20972    0.24568  -0.854    0.393
    ## x.kor       -0.09566    0.42943  -0.223    0.824
    ## 
    ## (Dispersion parameter for binomial family taken to be 1)
    ## 
    ##     Null deviance: 137.19  on 99  degrees of freedom
    ## Residual deviance: 137.14  on 98  degrees of freedom
    ## AIC: 141.14
    ## 
    ...
    ## Deviance Residuals: 
    ##     Min       1Q   Median       3Q      Max  
    ## -0.7585  -0.3271  -0.3271  -0.3271   2.4310  
    ## 
    ## Coefficients:
    ##             Estimate Std. Error z value Pr(>|z|)
    ## (Intercept)   -1.099      1.155  -0.951    0.341
    ## x.per         -1.803      1.243  -1.451    0.147
    ## 
    ## (Dispersion parameter for binomial family taken to be 1)
    ## 
    ##     Null deviance: 45.394  on 99  degrees of freedom
    ## Residual deviance: 43.783  on 98  degrees of freedom
    ## AIC: 47.783
    ## 
