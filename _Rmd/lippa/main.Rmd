...
knitr::include_graphics(paste0(imgspace, "/img/lippa1.png"))
```
...
knitr::include_graphics(paste0(imgspace, "/img/nonprob.png"))
```
...
knitr::include_graphics(paste0(imgspace, "/img/lippa2.png"))
```
...
knitr::include_graphics(paste0(imgspace, "/img/corrbeta1.png"))
```
